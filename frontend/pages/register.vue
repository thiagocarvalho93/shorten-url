<template>
  ...
  <form @submit.prevent="handleRegister" class="mx-auto max-w-md mt-12">
    <div class="space-y-6">
      <div>
        <label for="username" class="block mb-1 text-sm font-medium dark:text-white"
          >Username</label
        >
        <input
      ...
      <div>
        <label for="firstName" class="block mb-1 text-sm font-medium dark:text-white"
          >First Name</label
        >
        <input
      ...
      <div>
        <label for="lastName" class="block mb-1 text-sm font-medium dark:text-white"
          >Last Name</label
        >
        <input
